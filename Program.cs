...
namespace HashCode2018
{
	...
	public class Solution
	{
		...
		public void Solve(string fileName)
		{
			...
			List<string> lines = new List<string> {"StartStep", ArrayToString(startStep), "EndStep", ArrayToString(endStep), "Distance", ArrayToString(distance), "DistanceBetween", ArrayToString(distanceBetwenRide)};
